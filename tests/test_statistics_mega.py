...
import random
import pytest
from finlib.statistics import mean, variance, std, covariance, correlation, covariance_matrix, correlation_matrix, rolling_mean, rolling_std, ewma, ewma_from_span, skewness, kurtosis, percentile, median, quartiles, iqr, zscore, zscore_outliers, iqr_outliers, weighted_mean, geometric_mean, harmonic_mean
...
@pytest.mark.parametrize('num_series', [2, 4, 5])
@pytest.mark.parametrize('seed', SEEDS)
...
@pytest.mark.parametrize('n', SIZES)
@pytest.mark.parametrize('span', [5, 20, 100])
@pytest.mark.parametrize('seed', SEEDS)
...
@pytest.mark.parametrize('mu', [1, 10, 100])
@pytest.mark.parametrize('seed', SEEDS)
...
@pytest.mark.parametrize('mu', [2, 10, 50])
@pytest.mark.parametrize('seed', SEEDS)
