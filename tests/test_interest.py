...
def test_simple_interest_basic(principal: float, rate: float, time: float, expected: float):
...
def test_compound_interest_basic(principal: float, rate: float, time: float, n: int, expected: float):
...
def test_continuous_compound_interest(principal: float, rate: float, time: float, expected: float):
...
def test_future_value(principal: float, rate: float, time: float, n: int, expected: float):
...
def test_compound_interest_earned(principal: float, rate: float, time: float, n: int, expected: float):
