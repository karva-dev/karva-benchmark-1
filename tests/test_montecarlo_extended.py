...
@karva.tags.parametrize("S0", [50, 100, 200])
@karva.tags.parametrize("mu", [-0.05, 0.0, 0.05, 0.10])
@karva.tags.parametrize("sigma", [0.10, 0.20, 0.30])
...
@karva.tags.parametrize("S0", [100])
@karva.tags.parametrize("T", [0.5, 1.0, 2.0])
@karva.tags.parametrize("dt", [0.01, 0.005, 0.002])
...
@karva.tags.parametrize("S0", [80, 100, 120])
@karva.tags.parametrize("num_paths", [50, 100, 200])
...
@karva.tags.parametrize("S0", [80, 100, 120])
@karva.tags.parametrize("num_paths", [50, 100])
@karva.tags.parametrize("sigma", [0.15, 0.25, 0.35])
...
@karva.tags.parametrize("mu", [0.05, 0.08, 0.10])
@karva.tags.parametrize("sigma", [0.12, 0.18, 0.25])
...
@karva.tags.parametrize("value", [100000])
@karva.tags.parametrize("sigma", [0.15, 0.20, 0.25])
@karva.tags.parametrize("T", [1/252, 5/252, 10/252])
@karva.tags.parametrize("num_sims", [500, 1000, 2000])
...
@karva.tags.parametrize("K", [95, 100, 105])
@karva.tags.parametrize("sigma", [0.20, 0.30])
@karva.tags.parametrize("steps", [12, 52])
...
@karva.tags.parametrize("sigma", [0.25, 0.35])
...
@karva.tags.parametrize("barrier", [115, 120, 125])
@karva.tags.parametrize("sigma", [0.20, 0.30])
...
@karva.tags.parametrize("S", [95, 100, 105])
@karva.tags.parametrize("barrier", [75, 80, 85])
@karva.tags.parametrize("sigma", [0.20, 0.30])
...
@karva.tags.parametrize("S", [95, 100, 105])
@karva.tags.parametrize("barrier", [115, 120])
@karva.tags.parametrize("sigma", [0.20, 0.30])
...
@karva.tags.parametrize("num_paths", [100, 200, 500])
@karva.tags.parametrize("T", [0.5, 1.0, 2.0])
...
@karva.tags.parametrize("returns", [[0.05, 0.05], [0.08, 0.08], [0.10, 0.10]])
@karva.tags.parametrize("vols", [[0.10, 0.10], [0.15, 0.15], [0.20, 0.20]])
...
@karva.tags.parametrize("initial", [100000, 250000, 500000])
@karva.tags.parametrize("contribution", [10000, 20000, 30000])
@karva.tags.parametrize("return_rate", [0.05, 0.07, 0.09])
...
@karva.tags.parametrize("initial", [100000, 250000])
@karva.tags.parametrize("withdrawal", [30000, 50000, 80000])
@karva.tags.parametrize("volatility", [0.10, 0.15, 0.20])
...
@karva.tags.parametrize("years_saving", [10, 20, 30])
@karva.tags.parametrize("years_retirement", [20, 25, 30])
...
@karva.tags.parametrize("S", [100])
@karva.tags.parametrize("K", [95, 100, 105])
@karva.tags.parametrize("num_sims", [5000, 10000])
...
@karva.tags.parametrize("num_paths", [500, 1000])
@karva.tags.parametrize("steps", [252, 504])
